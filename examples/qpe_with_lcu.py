...
# %%
num_qubits = 4
H = heisenberg_hamiltonian(num_qubits)
...
plt.legend()
plt.title(f"Heisenberg {H.num_qubits} spins - LCU")
plt.ylabel("energy")
...
plt.legend()
plt.title(f"Heisenberg {H.num_qubits} spins - 2nd order Trotter {n_steps} steps")
plt.ylabel("energy")
plt.xlabel("number of phase qubits");
...
plt.legend()
plt.title(f"H2 STO-3 basis ({H_H2.num_qubits} qubits) - LCU")
plt.ylabel("energy")
plt.xlabel("number of phase qubits");
