...
print(f"num_qubits = {h2_ham_sto3g.num_qubits}")
...
print(f"num_qubits = {h2_ham.num_qubits}")
...
print(f"num_qubits = {o2_ham.num_qubits}")
...
print(f"num_qubits = {h2o_ham.num_qubits}")
